...
@Composable
fun SocialNetworkSignButtonPreview() {
    SocialNetworkSignButton(icon = R.drawable.ic_linkedin)
}

@Composable
fun PasswordInput(value: String, placeHolder: String, onValueChanged: (String) -> Unit) {
